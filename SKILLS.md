...
| ascii-art | ASCII art with pyfiglet, cowsay, boxes |
| ascii-video | Convert video/audio to colored ASCII |
...
| html-artifact | Build self-contained HTML files |
| humanizer | Strip AI-isms from text |
| manim-video | Math/algo animations (Manim CE) |
...
| Skill | Description |
|-------|-------------|
| codebase-inspection | Inspect codebases (LOC, languages) |
| github-auth | GitHub auth setup (HTTPS tokens, SSH) |
